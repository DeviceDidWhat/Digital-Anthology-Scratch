  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-32 pointer-events-none">
        ...
        <div
          className="absolute top-2 left-[25%] w-16 h-28 bg-primary/80 -rotate-6 animate-wave origin-top rounded-b-full"
          style={{ animationDelay: "0.3s" }}
        />
        <div
          className="absolute top-6 right-[20%] w-18 h-30 bg-mustard/80 rotate-6 animate-wave origin-top rounded-b-full"
          style={{ animationDelay: "0.6s" }}
        />
        <div
          className="absolute top-3 right-[35%] w-14 h-24 bg-peacock/80 -rotate-12 animate-wave origin-top rounded-b-full"
      ...
      <div className="relative z-10 text-center px-6 py-20 max-w-4xl mx-auto">
        ...
        {/* Tagline */}
        <p
          className="text-xl md:text-2xl text-foreground/90 font-body mb-10 max-w-2xl mx-auto leading-relaxed animate-fade-in"

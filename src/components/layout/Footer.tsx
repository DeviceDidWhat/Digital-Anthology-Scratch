        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/category/cuisine" className="text-primary-foreground/70 hover:text-mustard transition-colors">Cuisine & Spices</Link></li>
              <li><Link to="/category/festivals" className="text-primary-foreground/70 hover:text-mustard transition-colors">Festivals & Traditions</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <Link to="/category/textiles" className="text-2xl hover:scale-110 transition-transform">🧵</Link>
              <Link to="/category/folk-art" className="text-2xl hover:scale-110 transition-transform">🎨</Link>
              <Link to="/category/desert-life" className="text-2xl hover:scale-110 transition-transform">🐪</Link>
              <Link to="/category/music-dance" className="text-2xl hover:scale-110 transition-transform">💃</Link>
              <Link to="/category/cuisine" className="text-2xl hover:scale-110 transition-transform">🍛</Link>
              <Link to="/category/festivals" className="text-2xl hover:scale-110 transition-transform">🎉</Link>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-primary-foreground/50 text-sm">
              © 2026 Rangilo Rajasthan. Made with ❤️ for Rajasthani culture.
            </p>
